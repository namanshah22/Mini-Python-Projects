...
heading_text=Label(app,text="Welcome To Intenet Speed Checker",font='Arial 16 bold',fg='yellow',bg='black')
...
btn=Button(app,text="Check Speed here",font='Arial 14',fg='black',bg='aqua',border=5)
